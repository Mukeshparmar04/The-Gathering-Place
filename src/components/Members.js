...
//                         <span className="">{filteredMembers.length} members</span>
...
//                       </div>
//                     </div>
//                     <div className="d-flex flex-column flex-md-row justify-content-between align-items-center p-3 rounded shadow-lg">
//                         <div className="d-flex align-items-center mb-2 mb-md-0">
//                           <img
//                             alt="Anna"
//                             className="rounded-circle me-3"
//                             src="user-profil2.jpg"
//                             width="40"
//                             height="40"
//                           />
//                           <div>
//                             <p className="fw-semibold mb-0">Anna Jhon</p>
//                             <p className="text-muted mb-0">janna@acme.com</p>
//                           </div>
//                         </div>
//                         <div className="d-flex align-items-center mt-2 mt-md-0">
//                           <span className="bg-secondary text-white py-1 px-3 rounded">
