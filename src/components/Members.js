                  ...
                  <div className="p-2 fw-bold rounded shadow-lg">
                        ...
                        >
                          <div className="d-flex justify-content-between align-items-center w-100 px-2 ">
                            <div className="d-flex  position-relative  px-2 w-100 py-2 my-2 ">
                              ...
                              <input
                                className="form-control rounded py-2 px-4 mx-2 my-2 bg-transparent "
                                type="email"
                                name="email"
                                placeholder="Email"
                    ...
                    <div className="mb-2">
                      {filteredMembers.map((member, index) => (
                        <div
                          key={index}
                          className="d-flex flex-column flex-md-row justify-content-between align-items-center p-3 my-2 rounded shadow-lg w-100"
                        >
                ...
                <div className="py-2">
                  ...
                  <div className="p-2 fw-bold rounded shadow-lg">
                    ...
                    {filteredInvites.map((invite, index) => (
                      <div
                        key={index}
                        className="d-flex flex-column flex-md-row justify-content-between align-items-center p-3 my-2 rounded shadow-lg"
                      >
                        <div className="d-flex align-items-center mb-2 mb-md-0">
                          <img
                            alt={invite.name}
